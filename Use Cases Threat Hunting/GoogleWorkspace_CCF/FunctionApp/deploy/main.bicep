...
@description('Existing Log Analytics workspace name (Sentinel-enabled).')
param workspaceName string

@description('Resource group of the Log Analytics workspace. Defaults to the deployment RG.')
...
// -----------------------------------------------------------------------------
// Custom table (deployed in the workspace's RG via a module so this template
// can deploy to a different RG than the workspace).
// -----------------------------------------------------------------------------
module gwsTableModule 'table.bicep' = {
  name: 'gwsTable-deploy'
  scope: resourceGroup(workspaceResourceGroup)
  params: {
