<#
.SYNOPSIS
    Generate Microsoft 365 Copilot Sentinel ARM template from the YAML source files.
...
$template = [ordered]@{
    ...
    metadata         = @{
        description = 'Microsoft 365 Copilot - Microsoft Sentinel analytic rules and hunting queries.'
        author      = 'Sentinel-As-Code / Microsoft 365 Copilot bundle'
    }
    parameters       = [ordered]@{
        workspaceName        = @{
            type     = 'string'
